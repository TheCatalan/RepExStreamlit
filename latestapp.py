...
def render_fillin_template_ui(mapped_num_val: int, key: str, pools: dict, template_text: str, key_ns: str = ""):
    ...
    for i, pname in enumerate(PARAM_ORDER):
        ...
        # Prefer previously chosen answer; else default to placeholder ("Any/All")
        current = answers.get(pname, ANY_ALL_CHOICES[0])
...
def render_tutorial():
    ...
    st.markdown("""
Thank you for choosing to participate in our study designed to understand which types of model explanations help individuals understand the inner workings of models. You will advance through 18 trials where you will see a Prompt, AI Generated Output, and Model Explanations paired together. Then you will see an AI Generated Output by itself and reason through which prompt parameters were necessary to create the AI Generated Output. After each trial you will answer a 1 question survey about your confidence in your answer. After every three trials, you will also answer a short survey. The trials will be timed as we are interested not only in how different Model Explanation methods help you understand the models, but also how quickly they help you. We are not testing your ability to solve these problems—only the Model Explanation method’s ability to assist you. Please take the time you need to give as correct an answer as you can and answer the survey questions as honestly as you can.

 

**Trial Instructions**

1. You will be presented with a Prompt and its corresponding AI Generated Output. The types of AI Generated Outputs are noted below. Study this pairing then scroll down.

2. On the same page underneath the Prompt and AI Generated Output, you will be presented with a Model Explanation that is designed to help you understand the model. The types of Model Explanations are noted below. Study this explanation method then scroll down.

3. Underneath the Model Explanation, you will be presented with an AI Generated Output that does not have a prompt. You will have to select the parameters of the prompt via dropdown boxes located underneath this AI Generated Output. The parameters are time of day, max classes per day, days to have classes, and minimum course level.

4. When you have inputted your parameters, you will click **Next** to save and advance.

5. Answer the survey questions to the best of your ability and click **Next** to save and advance to the next trial.

 

**AI Generated Output Types**

1. Text Timetable: A text list of classes and their details.

2. Image Timetable: A timetable image with the classes arranged to show classes.

3. AI-Generated Timetable: A "timetable" image generated by an AI Model (GPT's Dall-e 3) to represent classes.
...
#         """)
    ...
    st.markdown("### Explanation Examples:")
...
if substep == 1:
    ...
    if expl_type == 2:
        ...
        for v in [1, 2]:
            ...
            with c2: 
                if rep_type == 3:
                    show_image_or_warn(rep_path(rep_type, num, v), custom_size=800)
                elif rep_type == 1:
                # show_image_or_warn(rep_path(rep_type, num, version), f"Rep v{version}")
                    show_image_or_warn(rep_path(rep_type, num, v), custom_size=1500)
                else:
                    show_image_or_warn(rep_path(rep_type, num, v))
